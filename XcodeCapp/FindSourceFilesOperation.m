...
- (id)initWithCappuccinoProject:(CappuccinoProject *)aCappuccinoProject path:(NSString *)path
{
    self = [super init];
...
- (void)createProcessingOperationForProjectSourcePath:(NSString *)projectSourcePath
{
    ...
    ProcessSourceOperation *op = [[ProcessSourceOperation alloc] initWithCappuccinoProject:self.cappuccinoProject sourcePath:projectSourcePath];
